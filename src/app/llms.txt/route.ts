...
export async function GET() {
  ...
  const body = [
    ...
    "## Discovery",
    "",
    `- [Sitemap index](${SITE.url}/sitemap.xml): Posts, categories, and pages`,
    `- [Posts sitemap](${SITE.url}/sitemap-posts.xml)`,
    `- [Categories sitemap](${SITE.url}/sitemap-categories.xml)`,
    `- [Pages sitemap](${SITE.url}/sitemap-pages.xml)`,
